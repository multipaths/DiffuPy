...
def generate_categoric_input_vector_from_labels(rows_labeled, col_label, background_mat, rows_unlabeled = None):
    ...
    return input_mat.match_missing_rows(background_mat.rows_labels, -1).match_rows(background_mat)


def generate_categoric_input_from_labels(rows_labels, cols_labels, background_mat, rows_unlabeled = None):
